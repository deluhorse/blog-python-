...
class CacheRouter:
    ...
    def string_set(key, **kwargs):
        ...
        result = async_redis.set(key, value, second)
        raise tornado.gen.Return(result)
    ...
    def hash_m_get(key, **kwargs):
        ...
        result = async_redis.hgetall(key)
        raise tornado.gen.Return(result)
    ...
    def hash_get(key, **kwargs):
        ...
        result = async_redis.hget(key, field)
        raise tornado.gen.Return(result)
    ...
    def hash_set(key, **kwargs):
        ...
        result = async_redis.hset(key, field, value)
        raise tornado.gen.Return(result)
    ...
    def hash_m_set(key, value, second):
        ...
        result = async_redis.hmset(key, value, second)
        raise tornado.gen.Return(result)
    ...
    def hash_del(key, **kwargs):
        ...
        result = async_redis.hdel(key, field)
        raise tornado.gen.Return(result)
