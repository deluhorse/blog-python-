...
class baseService(object):
    ...
    def vertify_code(self, int_vertify_length=6):
        """
        生成短信验证码
        :param int_vertify_length: 
        :return: 
        """
        str_charset = '0123456789'
        list_code = []
        for i in range(int_vertify_length):
            str_item = random.choice(str_charset)
            list_code.append(str_item)
