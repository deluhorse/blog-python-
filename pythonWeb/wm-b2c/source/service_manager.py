...
class ServiceManager(object):
    ...
    @staticmethod
    def do_remoteservice(url, params, http_type='get'):
        """
        执行远程服务
        :param url: 
        :param params: 
    ...
    def do_service(service_path='', method='', params={}, version=''):
        ...
        if service_path in REMOTE_CONTROLLER and method in REMOTE_CONTROLLER[service_path]:
            ...
            return ServiceManager.do_remoteservice(url, params, http_type=REMOTE_CONTROLLER[service_path][method][1])
        else:
            return ServiceManager.do_localservice(service_path, method, params, version)
